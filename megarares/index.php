...
<body>
	...
	<div class="cd-slider-nav">
            <nav>
              ...
              <ul>
                ...
                <li class="selected"><a href="../megarares/"><div class="image-icon"><img src="https://static.habbo-happy.net/img/furni/small/467107496690005.gif"></div><h6>Megarares</h6></a></li>
				<li><a href="../ltd/"><div class="image-icon"><img src="https://habboo-a.akamaihd.net/c_images/album1584/PIH10.gif"></div><h6>LTD</h6></a></li>
              </ul>
            </nav> 
          </div>
  ...
  <div class="table-rares">
   <div class="header"><B>Megarares</B></div>
   ...
   <table id="myTable" cellspacing="0">
	...
	$sql = ("SELECT ID, imagen, nombre, valor, descripcion FROM megas order by valor DESC");
	...
	do { 
		echo "<tr>
				...
				if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] == true){
					echo "<td><a href='/admin/editar-mega.php?id=".$row["ID"]."'>Editar</a></td>";
					echo "<td><a href='/admin/eliminar-mega.php?id=".$row["ID"]."'>Eliminar</a></td>";
				}
