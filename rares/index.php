...
<body>
	...
	<div class="cd-slider-nav">
            <nav>
              ...
              <ul>
                ...
                <li class="selected"><a href="../rares/"><div class="image-icon"><img src="https://habboo-a.akamaihd.net/c_images/album1584/SFR05.gif"></div><h6>Rares</h6></a></li>
  ...
  <div class="table-rares">
   ...
   <table id="myTable" cellspacing="0">
	...
	$sql = ("SELECT ID, imagen, nombre, valor, descripcion FROM rares order by valor DESC");
