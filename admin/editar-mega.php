...
<body>
	...
	$sql = "UPDATE megas SET imagen='$url', nombre='$nombre', valor='$valor', descripcion='$desc' WHERE ID='$id'";
    $link->query($sql);
...
?> 
			...
			<form method="post" action="" enctype="multipart/form-data" class="contact1-form validate-form">
				...
				$sql = ("SELECT ID, imagen, nombre, valor, descripcion FROM megas where ID = '$id'");
